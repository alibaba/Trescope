...
if __name__ == '__main__':
    ...
    Trescope().selectOutput(10).plotFRONT3D('../data/res/3D-FRONT-samples/scenes/07700701-1835-4532-8af0-bd8c7f624b1b.json').withConfig(
        FRONT3DConfig()
            .shapeLocalSource('../data/res/3D-FRONT-samples/3D-FUTURE-model')
            .view('top')
            .renderType('depth')
            .hiddenMeshes(['Ceiling', 'SlabTop', 'ExtrusionCustomizedCeilingModel']))
    Trescope().selectOutput(11).plotFRONT3D('../data/res/3D-FRONT-samples/scenes/dc74ad5c-34cf-4237-a3f3-a94297a907c8.json').withConfig(
        FRONT3DConfig()
            .shapeLocalSource('../data/res/3D-FRONT-samples/3D-FUTURE-model')
            .view('top')
            .renderType('normal')
